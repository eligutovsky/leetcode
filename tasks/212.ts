...
function findWords(board: string[][], words: string[]): string[] {
  ...
  // 2. Define recursive function to search for cell
  const dfs = (
    node: TrieNode,
    row: number,
    column: number,
    ...
    for (let [rowOffset, columnOffset] of directions) {
      dfs(node.map.get(letter)!, row + rowOffset, column + columnOffset);
    }
    board[row][column] = letter;
  };

  // 3. For each cell in the board, do a DFS  
...
console.log(
  findWords(
    [
      ...
      ["p","a","a","a","a","a","a","a","a","a","a","a"],["q","a","a","a","a","a","a","a","a","a","a","a"],["r","a","a","a","a","a","a","a","a","a","a","a"],["s","a","a","a","a","a","a","a","a","a","a","a"],["t","a","a","a","a","a","a","a","a","a","a","a"],["u","a","a","a","a","a","a","a","a","a","a","a"],["v","a","a","a","a","a","a","a","a","a","a","a"],["w","a","a","a","a","a","a","a","a","a","a","a"],["x","y","z","a","a","a","a","a","a","a","a","a"]
    ],
